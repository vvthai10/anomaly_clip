        ...
        self.resblocks = nn.Sequential(
            *[
                ResidualAttentionBlock(
                    width, heads, attn_mask, need_weights if i == layers - 1 else False
                )
...
class CLIP(nn.Module):
    def __init__(
        ...
        print("resnet --------------------")
        print("layers: ", vision_layers)
        print("output dim: ", embed_dim)
        print("heads ", vision_width * 32 // 64)
        print("img res ", image_resolution)
        print("image width: ", vision_width)
